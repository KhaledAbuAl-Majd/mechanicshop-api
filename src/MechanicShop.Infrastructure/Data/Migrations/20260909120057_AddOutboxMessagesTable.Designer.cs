...
namespace MechanicShop.Infrastructure.Data.Migrations
{
    ...
    [Migration("20260909120057_AddOutboxMessagesTable")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MechanicShop.Infrastructure.Outbox.OutboxMessage", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<DateTimeOffset>("LastModifyOnUtc")
                        .HasColumnType("datetimeoffset");
                    ...
                    SqlServerIndexBuilderExtensions.IsClustered(b.HasIndex("OccurredOnUtc"));

                    b.HasIndex("ProcessedOnUtc")
                        .HasFilter("[ProcessedOnUtc] IS NULL");

                    SqlServerIndexBuilderExtensions.IncludeProperties(b.HasIndex("ProcessedOnUtc"), new[] { "RetryCount" });
